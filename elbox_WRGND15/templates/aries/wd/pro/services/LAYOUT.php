...
function setup_switch($mode)
{
	if ($mode == "bridge") {
		...
		if ( $use_hw_snoop == 1 )
		{
			...
			startcmd("echo \"write 0x0214 0x01070707\" > /proc/ar8327/mii/ctrl1");
			...
			startcmd("echo \"write 0x0624 0x017f017f\" > /proc/ar8327/mii/ctrl1");
			...
			/* for hw igmp snoop */
			startcmd("echo \"write 0x0210 0x07070707\" > /proc/ar8327/mii/ctrl2");
			//HW snooping handle IPMP v3 
			startcmd("echo \"write 0x0214 0x01070707\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0620 0x000004f0\" > /proc/ar8327/mii/ctrl2");
			//startcmd("echo \"write 0x03c 0x00400000\" > /proc/ar8327/mii/ctrl1");
			//HW snooping for uknown multicast will only flood to CPU port and switch2 port6 that connect to switch1 port0
			startcmd("echo \"write 0x0624 0x417f417f\" > /proc/ar8327/mii/ctrl2");
			//ARL_CTRL Register, the group address is never aged-out before receiving the leave packet
			startcmd("echo \"write 0x0618 0x50f8002b\" > /proc/ar8327/mii/ctrl2");
		}
	}
	else {
		/* pro/storage enable hw snoop */
		...
		if ( $use_hw_snoop == 1 )
		{
			...
			//switch2 ARL table
			startcmd("echo \"write 0x0600 0x5e7ffffa\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0604 0x007f0100\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0608 0x0000010f\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x060c 0x80000002\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0600 0x0000000c\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0604 0x807f3333\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0608 0x0000010f\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x060c 0x80000002\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0600 0x5e0000fc\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0604 0x007f0100\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0608 0x0000010f\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x060c 0x80000002\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0600 0x00010003\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0604 0x807f3333\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x0608 0x0000010f\" > /proc/ar8327/mii/ctrl2");
			startcmd("echo \"write 0x060c 0x80000002\" > /proc/ar8327/mii/ctrl2");
			//switch1 ARL table
			startcmd("echo \"write 0x0600 0x5e7ffffa\" > /proc/ar8327/mii/ctrl1");
			startcmd("echo \"write 0x0604 0x00190100\" > /proc/ar8327/mii/ctrl1");
			...
			startcmd("echo \"write 0x0604 0x80193333\" > /proc/ar8327/mii/ctrl1");
			startcmd("echo \"write 0x0608 0x0000010f\" > /proc/ar8327/mii/ctrl1");
			startcmd("echo \"write 0x060c 0x80000002\" > /proc/ar8327/mii/ctrl1");
