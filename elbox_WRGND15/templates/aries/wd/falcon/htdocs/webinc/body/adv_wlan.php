...
<!--	<div class="textinput">
	...
	<div class="textinput" id="beamformer" style="display:none;">
		<span class="name"><?echo i18n("Beamformer");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input type="checkbox" class="name" id="beamformer_enable" onClick="PAGE.OnClickBeamformer('');"/>
		</span>
	</div>
	<div class="textinput" id="beamformee" style="display:none;">
		<span class="name"><?echo i18n("Beamformee");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input type="checkbox" class="name" id="beamformee_enable"/>
		</span>
	</div>
	<div class="gap"></div>
</div>
...
<!--	<div class="textinput">
	...
	<div class="textinput" id="beamformer_Aband" style="display:none;">
		<span class="name"><?echo i18n("Beamformer");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input type="checkbox" class="name" id="beamformer_enable_Aband" onClick="PAGE.OnClickBeamformer('_Aband');"/>
		</span>
	</div>
	<div class="textinput" id="beamformee_Aband" style="display:none;">
		<span class="name"><?echo i18n("Beamformee");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input type="checkbox" class="name" id="beamformee_enable_Aband"/>
		</span>
	</div>		
