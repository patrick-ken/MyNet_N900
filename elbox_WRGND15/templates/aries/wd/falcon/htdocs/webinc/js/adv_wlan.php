...
Page.prototype =
{
	...
	Initial: function(wlan_phyinf,wifi_phyinf)
	{
		...
		//beamforming setting
		if(XG(this.phyinf+"/media/beamforming/beamformer")!="")
		{
			OBJ("beamformer"+str_Aband).style.display = OBJ("beamformee"+str_Aband).style.display = "";
			if(COMM_ToBOOL(XG(this.phyinf+"/media/beamforming/beamformer")))
			{
				OBJ("beamformer_enable"+str_Aband).checked = true;
				OBJ("beamformee_enable"+str_Aband).disabled = false;
				OBJ("beamformee_enable"+str_Aband).checked = COMM_ToBOOL(XG(this.phyinf+"/media/beamforming/beamformee"));
			}
			else
			{
				OBJ("beamformer_enable"+str_Aband).checked = false;
				OBJ("beamformee_enable"+str_Aband).disabled = true;
				OBJ("beamformee_enable"+str_Aband).checked = false;				
			}		
		}	
...
//		XS(this.phyinf+"/wlmode",		OBJ("wlan_mode"+str_Aband).value);
		...
		//beamforming setting
		if(XG(this.phyinf+"/beamforming/beamformer")!="")
		{
			XS(this.phyinf+"/beamforming/beamformer", OBJ("beamformer_enable"+str_Aband).checked?"1":"0");
			XS(this.phyinf+"/beamforming/beamformee", OBJ("beamformee_enable"+str_Aband).checked?"1":"0");
		}		
	...
	OnClickBeamformer: function(str_Aband)
	{
		if(OBJ("beamformer_enable"+str_Aband).checked)
		{
			OBJ("beamformee_enable"+str_Aband).disabled = false;
		}
		else
