	...
	PreSubmit: function()
	{
		...
		{	
			...
			if(OBJ("dsc_"+i).value !== "")
			{
				...
				if(OBJ("src_startip_"+i).value === "" || OBJ("src_endip_"+i).value === "" || OBJ("dst_startip_"+i).value ==="" || OBJ("dst_endip_"+i).value ===""
					|| OBJ("src_startport_"+i).value === "" || OBJ("src_endport_"+i).value === "" || OBJ("dst_startport_"+i).value === ""|| OBJ("dst_endport_"+i).value === "")
				{
					...
					else if(OBJ("dst_startip_"+i).value === "")	OBJ("dst_startip_"+i).focus();
					else if(OBJ("dst_endip_"+i).value === "")	OBJ("dst_endip_"+i).focus();
					else if(OBJ("dst_startport_"+i).value === "")	OBJ("dst_startport_"+i).focus();
					else if(OBJ("dst_endport_"+i).value === "")	OBJ("dst_endport_"+i).focus();
					return null;
				}		
