...
if ($orion>0)
{
	...
	fwrite("a", $START, "iptables -t nat -A ORION.PFWD -p tcp --dport 80 -j DNAT --to-shift ".$ipaddr.":1200\n");
	fwrite("a", $START, "iptables -t nat -A ORION.PFWD -p tcp --dport 443 -j DNAT --to-shift ".$ipaddr.":1200\n");
