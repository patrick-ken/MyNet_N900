...
{
	set_result("FAILED", $FATLADY_prefix."/acl/inbfilter/count", i18n("Exceeded maximum number of rules."));
	$rlt = "-1";
}
else
{
	foreach ($FATLADY_prefix."/acl/inbfilter/entry")
	{
		...
		foreach ($FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry")
		{
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/startip:".query("seq"),i18n("The start IP address can not be in the LAN network."));
				$rlt = "-1";
				break;
			}
			...
			{
				set_result("FAILED",$FATLADY_prefix."/acl/inbfilter/entry:".$INX."/iprange/entry:".$INX2."/endip:".query("seq"),i18n("The end IP address can not be in the LAN network."));
				$rlt = "-1";
				break;
			}			
