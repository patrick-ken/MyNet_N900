...
/* update ntp list 2012.0126 Daniel Chen */
movc("ntp_list", "/device/time/ntp_list");
	
$ParentControlRestart = query($SETCFG_prefix."/runtime/device/ParentControlRestart");
TRACE_debug("SETCFG/$ParentControlRestart: ".$ParentControlRestart);
set("/runtime/device/ParentControlRestart", $ParentControlRestart);
?>
