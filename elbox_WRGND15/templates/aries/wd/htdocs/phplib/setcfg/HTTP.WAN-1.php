...
$infp_bridge = XNODE_getpathbytarget("", "inf", "uid", "BRIDGE-1", 0);
if ($infp!="")
{
	...
	/* Fixed WD ITR65457, Let interface bridge can start service STUNNEL in AP mode */
	set($infp_bridge."/stunnel", query($SETCFG_prefix."/inf/stunnel"));
