...
if(query(INF_getinfpath($WAN1)."/open_dns/nonce")!=$_GET["nonce"])
{
	$Response="BindError";
}
	...
	<body style="text-align:center" onload="BODY.OnLoad();">
		<div style="height:400px;width:800px;">
			...
			<div id="success" style="display:none;">
				...
				<br>
				<br>
				<div align="left"><? echo i18n("Congratulations! Your user account and your router have been registered with OpenDNS. Click CONTINUE to configure your Cloud-based Parental Control settings.");?></div>
				<br>
				<br>
				<br>		
			...
			<div id="fail" style="display:none;">
				...
				<br>
				<br>
				<div align="left"><? echo I18N("h", "This could have happened because the operation timed out or your router detected a security risk.");?></div>
				<br>
				<br>
				<div align="left"><? echo I18N("h", "Please click RESTART to restart the Cloud-based Parental Control program.");?></div>
				<br>
				<br>
				<br>
