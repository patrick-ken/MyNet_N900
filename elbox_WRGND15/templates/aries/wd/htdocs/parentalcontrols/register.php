...
{
	if(query("name")==$_GET["username"] && query("password")==$_GET["password"] && query("group")=="0")
	{
		$Response="";
		break;
	}	
...
?>
		<script type="text/javascript">
			...
			Body.prototype =
			{
				...
				LoginSubmit: function(password_type, overwrite_deviceid)
				{
					...
					self.location.href = "/parentalcontrols/register.php?username=admin&password=" + pwd + "&overriteDeviceID=" + overwrite_deviceid;
				},
	...
	<body style="text-align:center" onload="BODY.OnLoad();">
		<div style="height:400px;width:800px;">
			<div align="center">
				<img src="/pic/wd_utility.jpg" width="800" height="80">
			</div>
			<div id="authorize" style="display:none;">
				...
				<br>
				<br>
				<div align="left"><? echo i18n("NOTE: After successfully logging into your router, you will be presented with the login page for <a href='http://www.opendns.com/' target='_blank'>OpenDNS</a>&reg;, which is the company that provides the Cloud-based Parental Control service. After logging in or registering on that page, you will be able to configure your Cloud-based Parental Control settings.");?></div>		
			</div>
			
			<div id="InternetUnreach" style="display:none;">
				<div align="left"><? echo I18N("h", "The router can not detect the Cloud-based Parental Control server. Check that the router¡¦s Internet settings are configured correctly. For instance, if you use a PPPoE connection, check that the username/password settings are correct.");?></div>			
				<br>
				<br>
				<div align="center">
