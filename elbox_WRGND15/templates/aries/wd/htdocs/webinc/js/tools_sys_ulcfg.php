...
<?
		if ($_GET["RESULT"]=="SUCCESS")
		{
			...
			echo '\t\tvar banner = "'.I18N("h", "Restore Succeeded").'";';
			echo '\t\tvar msgArray = ["'.I18N("h", "The restored configuration file has been uploaded successfully.").'"];';
			echo '\t\tvar sec = '.$bt.';';
...
{	
	...
	var msgArray = ["<?echo I18N("h", "If you changed the IP address of the AP or wireless stations, you will need to enter the new IP address in your browser to access the configuration web page.");?>"];
	var delay = 10;
