...
New_help.prototype = 
{
	init: function() 
	{
		...
		{
			if( (span[i].className=="help" || span[i].className=="help_showdown" || span[i].className=="help_reverse") && span[i+1].className=="help_msg" ) 
			{
				if(!NewHelp.overlap(span[i]))
				{
					span[i].onclick = this.help_display;
					span[i].innerHTML = '<img src="pic/help.png" width="15" height="14" onmouseover="this.src=\'pic/help_hover.png\'" onmouseout="this.src=\'pic/help.png\'" />';
					...
					else if (span[i].className=="help_showdown")
					{
						var str='<div class="help_box_down">' +
									'<div class="help_box_down_top" onclick="this.parentNode.parentNode.style.display=\'none\'"><div class="help_box_top_title">' + help_title + '</div></div>' +
									'<div class="help_box_middle"><div class="help_box_middle_text">' + help_text + '</div></div>' +
									'<div class="help_box_down_bottom"></div>' +
								'</div>';
					}
					else if (span[i].className=="help_reverse")
					{
						var str='<div class="help_box_reverse">' +
									'<div class="help_box_top" onclick="this.parentNode.parentNode.style.display=\'none\'"><div class="help_box_top_title">' + help_title + '</div></div>' +
									'<div class="help_box_middle"><div class="help_box_middle_text">' + help_text + '</div></div>' +
									'<div class="help_box_bottom_reverse"></div>' +
								'</div>';
					}
