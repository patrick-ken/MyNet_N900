...
{
	$enable= $_POST["en"];//0:OFF 1:content filtering 2:schedule block
	$loc = $_POST["location"];
	$com2 = "service PARENTCTRL restart";
	...
	{/* if user choose to using Netstar, disabled Parent Scheduling */
		set("/security/active", "1" );
		set("/security/netstar/enable", "1" );
		set("/security/netstar/location", $loc );
		set("/security/parental/enable", "0" );
	}
	else if($enable=="2")
	{
		set("/security/active", "1" );
		set("/security/netstar/enable", "0" );
		set("/security/parental/enable", "1" );
	}
