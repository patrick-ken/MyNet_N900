...
{
	IP6T_newchain($START, "filter", "FWD.PCTL-1");
	IP6T_newchain($START, "filter", "FWD.PCTL-2");
	IP6T_newchain($START, "filter", "PCTL.SCH");
	IP6T_newchain($START, "filter", "PCTL.DAILY");
	fwrite(a,$START, "ip6tables -A FWD.PCTL-1 -j PCTL.SCH\n");
	fwrite(a,$START, "ip6tables -A FWD.PCTL-1 -j PCTL.DAILY\n");
	fwrite(a,$START, "ip6tables -A FWD.PCTL-2 -m connmark2 --mark 64/192 -j ACCEPT\n");
	fwrite(a,$START, "ip6tables -A FWD.PCTL-2 -m connmark2 --mark 128/192 -j DROP\n");
}
