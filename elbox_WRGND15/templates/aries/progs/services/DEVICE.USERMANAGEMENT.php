...
/* Create root account */
startcmd("addgroup -S -g 0 root");
startcmd("adduser -D -S -u 0 -G root root");
/* Create nobody */
startcmd("adduser -D -u 500 nobody");
startcmd("addgroup nobody nobody");
/* group name shortcut */
$GROUP_0	= "root";
$GROUP_500	= "nobody";
...
foreach ("/device/account/entry")
{
	...
	startcmd("adduser -D".$uidcmd." -G ".$group." ".$name);
