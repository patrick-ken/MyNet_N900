...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <GetDeviceSettingsResponse xmlns="http://purenetworks.com/HNAP1/">
      ...
      <Type><?
	if (query("/device/layout")=="router") { echo "GatewayWithWiFi"; } else { echo "WiFiAccessPoint"; }
      ?></Type>
      <DeviceName><? echo get("x","/sys/devicename");?></DeviceName>
      <VendorName><? echo query("/runtime/device/vendor");?></VendorName>
      <ModelDescription><? echo query("/runtime/upnp/dev/devdesc/device/modelDescription");?></ModelDescription>
      <ModelName><? echo query("/runtime/device/modelname");?></ModelName>
      <FirmwareVersion><? echo query("/runtime/device/firmwareversion");?>, <? echo query("/runtime/device/firmwarebuilddate");?></FirmwareVersion>
