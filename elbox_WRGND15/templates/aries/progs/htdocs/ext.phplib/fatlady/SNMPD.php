...
function EditPublicCommunity($path)
{
   ...
   //  TRACE_debug("readonlycommunity =".$readonlycommunity);
     ...
     {
          set_result("FAILED","",i18n("Please enter public community string.")); 
          return 0;     
     }
	  return 1;
}
...
function EditPrivateCommunity($path)
{
    ...
    // TRACE_debug("readwritecommunity =".$readwritecommunity);
     ...
     {
         set_result("FAILED","",i18n("Please enter private community string.")); 
        return 0;       
     }
	    return 1;
}
...
function CLI_AddHost($path)
{
    ...
    {
       set_result("FAILED","","Please enter correct IP address!.");
       return 0;       
    }
