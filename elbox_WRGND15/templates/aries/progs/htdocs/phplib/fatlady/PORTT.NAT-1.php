...
function check_portt_config($prefix, $nat)
{
	...
	foreach($base."/entry")
	{
		...
		if ($pt_start=="")
		{
			set_result("FAILED",$base."/entry:".$InDeX."/trigger/start",i18n("Please enter the trigger port range."));
			$rlt = "-1";
			break;
		}
		...
		if ($pt_list=="")
		{
			set_result("FAILED",$base."/entry:".$InDeX."/external/portlist",i18n("Please enter the port range of firewall."));
			$rlt = "-1";
			break;
		}
