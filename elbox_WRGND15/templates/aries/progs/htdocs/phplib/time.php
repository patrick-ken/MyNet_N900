...
/* 41 */else if ($name=="(GMT+04:00) Moscow, St. Petersburg, Volgograd") return "(GMT+04:00) ".i18n("Moscow, St. Petersburg, Volgograd");
...
/* 47 */else if ($name=="(GMT+06:00) Ekaterinburg")					return "(GMT+06:00) ".i18n("Ekaterinburg");
...
/* 51 */else if ($name=="(GMT+07:00) Almaty, Novosibirsk")			return "(GMT+07:00) ".i18n("Almaty, Novosibirsk");
...
/* 56 */else if ($name=="(GMT+08:00) Krasnoyarsk")					return "(GMT+08:00) ".i18n("Krasnoyarsk");
/* 57 */else if ($name=="(GMT+08:00) Beijing, Chongqing, Hong Kong, Urumqi") return "(GMT+08:00) ".i18n("Beijing, Chongqing, Hong Kong, Urumqi");
/* 58 */else if ($name=="(GMT+09:00) Irkutsk, Ulaan Bataar")		return "(GMT+09:00) ".i18n("Irkutsk, Ulaan Bataar");
...
/* 64 */else if ($name=="(GMT+10:00) Yakutsk")						return "(GMT+10:00) ".i18n("Yakutsk");
...
/* 71 */else if ($name=="(GMT+11:00) Vladivostok")					return "(GMT+11:00) ".i18n("Vladivostok");
/* 72 */else if ($name=="(GMT+12:00) Magadan, Solomon Is., New Caledonia") return "(GMT+12:00) ".i18n("Magadan, Solomon Is., New Caledonia");
