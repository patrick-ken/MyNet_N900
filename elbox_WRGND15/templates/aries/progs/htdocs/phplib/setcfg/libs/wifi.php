...
function phyinf_setcfg($prefix_phyinf)
{
	...
	set($to."/realtek/wlmode",			query("realtek/wlmode"));
	set($to."/realtek/dot11n/mcs/auto",	query("realtek/dot11n/mcs/auto"));
	set($to."/realtek/dot11n/mcs/index",	query("realtek/dot11n/mcs/index"));
	set($to."/realtek/txrate",			query("realtek/txrate"));
	set($to."/realtek/wmm/enable",		query("realtek/wmm/enable"));
	set($to."/realtek/guestaccess",		query("realtek/guestaccess"));
	if ($parent=="")
	{
		...
		set($to."/media/coexist",           query("media/coexist"));
		set($to."/media/stbc",           query("media/stbc"));
		set($to."/media/iapp",           query("media/iapp"));
		set($to."/media/ampdu",           query("media/ampdu"));
