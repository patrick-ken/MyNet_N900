...
#define MSG_GOODBYE "Au revoir. Vous avez uploade %llu et downloade %llu Koctets."
...
#define MSG_KBYTES_LEFT "%.1f Koctets a downloader"
...
#define MSG_SPACE_FREE_M "%.1f Moctets d'espace disque libre"
#define MSG_SPACE_FREE_K "%f Koctets d'espace disque libre"
