 ...
 */
#if (defined CONFIG_4KSTACKS || (PAGE_SIZE > 4096))
...
struct thread_info {
	...
	mm_segment_t addr_limit;		/* Limit on allowed addresses */
...
#define TIF_RECURSIVE_DIE	31	/* die() has been recursively called */

/* 
 * Same as above, but as bit values 
 */
#define _TIF_SYSCALL_TRACE	(1 << TIF_SYSCALL_TRACE)
#define _TIF_SIGPENDING		(1 << TIF_SIGPENDING)
#define _TIF_NEED_RESCHED	(1 << TIF_NEED_RESCHED)
#define _TIF_POLLING_NRFLAG	(1 << TIF_POLLING_NRFLAG)
#define _TIF_RECURSIVE_DIE	(1 << TIF_RECURSIVE_DIE)
