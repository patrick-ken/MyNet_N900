...
#define dwc_dma_flush(buf, size)        ubi32_dma_flush(buf, size)
#define dwc_dma_invalidate(buf, size)   ubi32_dma_invalidate(buf, size)
...
#endif
extern void ubi32_dma_flush(void *buf, unsigned int size);
extern void ubi32_dma_invalidate(void *buf, unsigned int size);
