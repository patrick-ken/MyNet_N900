...
void br_stp_recalculate_bridge_id(struct net_bridge *br)
{
	...
	/* __KERNEL_PATCH__
	 * I mark the following code, to let the bridge interface use MAC address of the first added interface.
	 * not to use the MAC address of the new added interface
	 * */
	list_for_each_entry(p, &br->port_list, list) {
#if 0
		if (addr == br_mac_zero ||
